...
;// CONCATENATED MODULE: ./src/ts/createHistory.ts
...
const onMouseOver = (e, $markRect, $markText) => {
    ...
    if (target.classList.contains('mark-rect') ||
        target.classList.contains('mark-text') ||
        ((_a = target.textContent) === null || _a === void 0 ? void 0 : _a.includes('월'))) {
        return;
    }
...
/* harmony default export */ const createHistory = (setRecsWithHistories);

;// CONCATENATED MODULE: ./src/ts/settings.ts
...
let loading = false;
const getHistoriesFromBackend = () => __awaiter(void 0, void 0, void 0, function* () {
    loading = true;
    if (!serverAddress) {
        console.log('result of env file is undefined');
        return;
    }
    const res = yield fetch(serverAddress);
    const data = yield res.json();
    loading = false;
    return data;
});
const addHistoriesToDom = () => __awaiter(void 0, void 0, void 0, function* () {
    const histories = yield getHistoriesFromBackend();
    if (!loading && $loading) {
        $loading.innerHTML = '';
    }
